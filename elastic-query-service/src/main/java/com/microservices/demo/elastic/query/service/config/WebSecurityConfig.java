...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    protected JwtDecoder jwtDecoder(@Qualifier("elastic-query-service-audience-validator") OAuth2TokenValidator<Jwt> audienceValidator) {
    ...
    @Bean
    protected Converter<Jwt, ? extends AbstractAuthenticationToken> twitterQueryUserJwtConverter() {
