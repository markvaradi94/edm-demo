...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private void simulateTwitterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) {
        Executors.newSingleThreadExecutor().submit(() -> simulateStream(keywords, minTweetLength, maxTweetLength, sleepTimeMs));
    }

    private void simulateStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) {
        try {
            while (true) {
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping for waiting new status to get created.");
        }
    }
    ...
    private String getRandomTweetContent(String[] keywords, int minTweetLength, int maxTweetLength) {
        ...
        return buildRandomTweet(keywords, tweet, tweetLength);
    }

    private String buildRandomTweet(String[] keywords, StringBuilder tweet, int tweetLength) {
